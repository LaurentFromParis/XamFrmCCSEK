...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "EmptyKeysTestCCSP.Droid.dll" comes first in this list. */
		"EmptyKeysTestCCSP.Droid.dll",
		"box2d.dll",
		"CocosSharp.dll",
		"CocosSharp.Forms.dll",
		"EmptyKeys.UserInterface.CocosSharp.dll",
