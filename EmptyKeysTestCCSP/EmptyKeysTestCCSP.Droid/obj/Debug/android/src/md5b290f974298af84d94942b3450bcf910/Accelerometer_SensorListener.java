package md5b290f974298af84d94942b3450bcf910;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", Accelerometer_SensorListener.class, __md_methods);
	}
	...
	public Accelerometer_SensorListener () throws java.lang.Throwable
	{
		...
		if (getClass () == Accelerometer_SensorListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
